        ...
        $(document).ready(function(){
            ...
            // Die Draggable Objekte werden aufgerufen. Diese stellen die RFID Transponder da.
				$.ajax({ 
					...
					url : 'https://localhost:7059/api/v1/Chip',
					dataType: 'json', 
				...
				$.ajax({ 
					...
					url: 'https://localhost:7059/api/v1/Reader',
					dataType: 'json', 
					success: function(data) {
						//console.log(data);						
				...
				$.ajax({ 
					...
					url: 'https://localhost:7059/api/v1/DataBaseSettings',					
					dataType: 'json', 
					success: function(data) {
						//console.log(data);
						var DBSettings = "";
            ...
            function CheckAccess(RFID_ID, RFID_Reader){
				...
				var chipId = RFID_ID.replace("draggable_", ""); // Entfernt "draggable_"
				var readerId = RFID_Reader.replace("RFIDReader_", ""); // Entfernt "RFIDReader_"
                var urlAccessAttempt = `https://localhost:7059/api/v1/CheckAccess/${chipId}/${readerId}`;
                // Ajax Aufruf
                $.ajax({
                    type: "POST", // HTTP method POST or GET
                    //url: "ajax/ajax_save.php", //Where to make Ajax calls
					url: urlAccessAttempt,
                    dataType:"json", 
